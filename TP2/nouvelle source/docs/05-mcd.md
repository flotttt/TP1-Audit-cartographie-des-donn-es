...
flowchart LR
    ...
    EARTHQUAKE["<b>EARTHQUAKE</b><br/>──────────<br/><u>id</u><br/>time<br/>magnitude<br/>mag_type<br/>place<br/>longitude<br/>latitude<br/>depth_km<br/>tsunami<br/>significance<br/>url"]
